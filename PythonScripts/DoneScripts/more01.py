...
if per.Status == PromptStatus.OK:
	...
	P[0][skolko-1][0]=pnt2[0]
	P[0][skolko-1][1]=pnt2[1]
	P[0][skolko-1][2]=pnt2[2]
	...
	for i in range(1,skolko):
		...
		#text=doc.ModelSpace.AddText(" "+str(i),point,0.2)
		#text=doc.ModelSpace.AddText("net",point,0.2)
		#doc.Utility.Prompt("\ni="+str(i))

	for i in range(1,skolko+1):
		p1=make_point(P[1][i][0],P[1][i][1],P[1][i][2])
		p2=make_point(P[1][i-1][0],P[1][i-1][1],P[1][i-1][2])
		p3=make_point(P[0][i-1][0],P[0][i-1][1],P[0][i-1][2])
		face=doc.ModelSpace.Add3DFace(p1,p2,p3,p1)


	for i in range(0,skolko-1):
		p1=make_point(P[0][i][0],P[0][i][1],P[0][i][2])
		p2=make_point(P[0][i+1][0],P[0][i+1][1],P[0][i+1][2])
		p3=make_point(P[1][i+1][0],P[1][i+1][1],P[1][i+1][2])
		face=doc.ModelSpace.Add3DFace(p1,p2,p3,p1)
