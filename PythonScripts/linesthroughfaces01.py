...
def dist(a,b):
	...
	return c
def select_points_between_2_points(pnt1,pnt2,minL):
	L=dist(pnt1,pnt2)
	...
	for m in midpoints:
		if i==0:
			...
			if dist(m,checkedpoints[-1])>minL:
				checkedpoints.append(m)
...
if per.Status == PromptStatus.OK:
	...
	midpoints=select_points_between_2_points(pnt1,pnt2,minL)
	...
	if len(midpoints)>0:
		...
		for i in range(0,len(midpoints)):
			...
			point=doc.ModelSpace.AddPoint(p02)
